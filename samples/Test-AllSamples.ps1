...
function TestAllSamples
{
	...
	RaiseAssertions
	write-host "Testing JoinString...(Exception text expected in console.)"
	.\Test-JoinString.ps1
	...
	RaiseAssertions
	write-host "Testing Simple REST API..."
	.\Test-SimpleRestAPI.ps1
	write-host "Finished testing Simple REST API."
